package co.com.jccp.ealgorithms.graphs;
...
public class MatlabChart {
    ...
    public void saveas(String fileName, int width, int height) {
        ...
        try {
            ChartUtils.saveChartAsJPEG(file, 1.0f,this.chart,width,height);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    public void saveasSVG(String fileName, int width, int height) {
        CheckExists();
        File file = new File(fileName);
